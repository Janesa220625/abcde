  ...
  try {
    ...
    try {
      ...
      if (tablesError) {
        ...
        details.tablesAvailable = tablesData as string[];
    ...
    return {
      ...
      lastName:
        profile && typeof profile === "object" && "last_name" in profile
          ...
          : undefined,
      warehouseId:
        profile && typeof profile === "object" && "warehouse_id" in profile
          ? (profile.warehouse_id as string)
          : undefined,
      ...
      updatedAt:
        profile && typeof profile === "object" && "updated_at" in profile
